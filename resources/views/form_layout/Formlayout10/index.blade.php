                ...
                <div class="form-wrapper">
                    ...
                    <div class="form-inner">
                        ...
                        <div class="myContainer">
                                                ...
                                                <div class="appointment-form">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 col-12">
                                                            ...
                                                            <small class="text-muted">(+23412345678)</small>
                                ...
                                <div class="appointment-wrp">
                                    ...
                                    <div class="appointment-form payment-method-form">
                                        ...
                                        <div class="row">
                                            ...
                                            @include('partials.payment-options', ['service' => $services->where('id', request()->get('service', $services->first()->id))->first(), 'currency_setting' => $currency_setting])
                                            
                                            {{-- Terms & Conditions Section --}}
                                            @include('partials.terms-conditions-checkbox')
                                        </div>
                                    </div>
                            ...
                            <script>
                                // Integrate partial payment with form submission
                                document.addEventListener('DOMContentLoaded', function() {
                                    // Add hidden fields for partial payment data
                                    const form = document.getElementById('appointment-form');
                                    
                                    // Create hidden inputs for partial payment information
                                    let paymentOptionInput = document.createElement('input');
                                    paymentOptionInput.type = 'hidden';
                                    paymentOptionInput.name = 'payment_option';
                                    paymentOptionInput.id = 'payment_option_hidden';
                                    paymentOptionInput.value = 'full';
                                    form.appendChild(paymentOptionInput);
                                    
                                    let partialAmountInput = document.createElement('input');
                                    partialAmountInput.type = 'hidden';
                                    partialAmountInput.name = 'partial_amount';
                                    partialAmountInput.id = 'partial_amount_hidden';
                                    partialAmountInput.value = '0';
                                    form.appendChild(partialAmountInput);
                                    
                                    let remainingAmountInput = document.createElement('input');
                                    remainingAmountInput.type = 'hidden';
                                    remainingAmountInput.name = 'remaining_amount';
                                    remainingAmountInput.id = 'remaining_amount_hidden';
                                    remainingAmountInput.value = '0';
                                    form.appendChild(remainingAmountInput);
                                    
                                    // Update hidden fields when payment option changes
                                    function updatePaymentHiddenFields() {
                                        ...
                                        if (fullPaymentRadio && partialPaymentRadio) {
                                            if (partialPaymentRadio.checked && window.currentServiceData) {
                                                paymentOptionInput.value = 'partial';
                                                
                                                const serviceData = window.currentServiceData;
                                                const servicePrice = parseFloat(serviceData.price) || 0;
                                                const depositAmount = Math.min(parseFloat(serviceData.partial_payment_amount) || 0, servicePrice);
                                                const remainingAmount = servicePrice - depositAmount;
                                                
                                                partialAmountInput.value = depositAmount;
                                    ...
                                    document.addEventListener('change', function(e) {
                                        if (e.target && (e.target.id === 'full_payment' || e.target.id === 'partial_payment')) {
                                            updatePaymentHiddenFields();
                                        }
                                    });
                                    
                                    // Update when service selection changes
                                    document.addEventListener('serviceUpdated', function() {
                                        updatePaymentHiddenFields();
                                    });
                                    
                                    // Initial update
                                    setTimeout(updatePaymentHiddenFields, 500);
                                });
                            </script>
