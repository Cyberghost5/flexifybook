    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::date('date', null, ['class' => 'form-control', 'placeholder' => __('Select Start Date'), 'required' => 'required']) }}
                @error('date')
        ...
        <div class="col-md-6">
            <div class="form-group mb-0">
                ...
                {{ Form::date('end_date', null, ['class' => 'form-control', 'placeholder' => __('Select End Date')]) }}
