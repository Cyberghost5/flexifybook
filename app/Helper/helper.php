...
if (!function_exists('currency_format_with_sym')) {
    ...
    function currency_format_with_sym($price, $company_id = null, $business = null)
    {
        ...
        $symbol_position = 'pre';
        $symbol = isset($company_settings['defult_currancy_symbol']) ? $company_settings['defult_currancy_symbol'] : '₦';
        $format = '1';
        $currency_space = null;
...
if (!function_exists('get_currency_format_and_symbol')) {
    function get_currency_format_and_symbol($company_id = null, $business = null)
    {
        ...
        $symbol_position = 'pre';
        $currancy_symbol = isset($company_settings['defult_currancy_symbol']) ? $company_settings['defult_currancy_symbol'] : '₦';
        $currancy_format = 1;
